function GR = growthrate(Ri,Pe,Lambda,Pr,tau,kx_list,ky_list,N)
    ...
    if canUseParallelPool
        ...
        parfor kx_index=1:sizeOfkx
            ...
            for ky_index=1:sizeOfky
               ky=ky_list(ky_index);
               % compute eigenvalues
            %    [~,eig_val] = eig_Radko2016(Ri,Pe,Lambda,Pr,tau,kx,ky,N);
               [~,eig_val] = eig_fullSDDC(Ri,Pe,Lambda,Pr,tau,kx,ky,N);
            %    [~,eig_val] = eig_reducedSDDC(Ri,Pe,Lambda,Pr,tau,kx,ky,N);
